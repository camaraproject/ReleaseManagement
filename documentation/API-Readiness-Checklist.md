...
|  2 | Design guidelines from Commonalities applied |   O   |         M         |    M    |    M   |      | Comm. version |
|  3 | Guidelines from ICM applied                  |   O   |         M         |    M    |    M   |      | ICM version |
|  4 | API versioning convention applied            |   M   |         M         |    M    |    M   |      | api-version |
...
- in the Reference information column, provide the links to the asset once available, the applicable versions (not release numbers) of Commonalities and ICM, and any other relevant links or information.

(*) In the Reference informationn colume, for the point 12: you can copy the following link if your previous API version has been certified: [GSMA OGW Portal](https://www.open-gateway.com/operators-map).
